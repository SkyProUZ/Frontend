                ...
                <div className="col-md-6">
                  <div className="information_module">
                    <a className="toggle_title" href="#collapse2" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapse1">
                      <h4>Shaxsiy Ma'lumotlar <span className="lnr lnr-chevron-down" /></h4>
                    </a>
                    <div className="information__set toggle_module collapse in" id="collapse2">
                      <div className="information_wrapper form--fields">
                        <div className="form-group">
                          <label htmlFor="usrname">Ism<sup>*</sup></label>
                          <input ref="first_name" name="first_name" type="text" id="usrname" placeholder="Ism" onChange={this.handleChange.bind(this)} value={this.state.first_name} />
                        </div>
                        <div className="form-group">
                          <label htmlFor="usrname">Familiya<sup>*</sup></label>
                          <input ref="last_name" type="text" name="last_name" id="usrname" placeholder="Familiya" onChange={this.handleChange.bind(this)} value={this.state.last_name} />
                        </div>
                        <div className="form-group">
                          <label htmlFor="emailad">Elektron pochta <sup>*</sup></label>
                          <input ref="email" type="text" name="email" id="emailad" placeholder="Elektron pochta " onChange={this.handleChange.bind(this)} value={this.state.email} />
                        </div>
                        <div className="form-group">
                          <label htmlFor="emailad">Telefon raqam <sup>*</sup></label>
                          <input ref="phone_number" name="phone_number" type="text" id="emailad" placeholder="Elektron pochta" onChange={this.handleChange.bind(this)} value={this.state.phone_number} />
                        </div>
                        {/* <div className="form-group">
